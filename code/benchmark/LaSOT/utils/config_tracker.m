...
trackers = {  
              struct('name', 'TransT_with_IB',       'publish', 'XXX') ...
              struct('name', 'TransT_with_TB',       'publish', 'XXX') ...
              struct('name', 'TrDiMP_with_IB',       'publish', 'XXX') ...
              struct('name', 'TrDiMP_with_TB',       'publish', 'XXX') ...
              struct('name', 'SiamRPN++_with_IB',       'publish', 'XXX') ...
              struct('name', 'SiamRPN++_with_TB',       'publish', 'XXX') ...]
              struct('name', 'ECO_with_IB',       'publish', 'XXX') ...
              struct('name', 'ECO_with_TB',       'publish', 'XXX') ...
              struct('name', 'HDT_with_IB',       'publish', 'XXX') ...
              struct('name', 'HDT_with_TB',       'publish', 'XXX') ...
              struct('name', 'CREST_with_IB',       'publish', 'XXX') ...
              struct('name', 'CREST_with_TB',       'publish', 'XXX') ...
              struct('name', 'DSiam_with_IB',       'publish', 'XXX') ...
              struct('name', 'DSiam_with_TB',       'publish', 'XXX') ...
%               struct('name', 'HCFT_with_IB',       'publish', 'XXX') ...
%               struct('name', 'HCFT_with_TB',       'publish', 'XXX') ...
%             struct('name', 'BACF',       'publish', 'ICCV-17') ...
