...
switch evalType
    case 'SRE'
        rpAll=['/data/object_tracking/batchmark/OTB100_benchmark/tracker_benchmark_v1.0/results/results_SRE_OTB100/'];
    case {'TRE', 'OPE'}
        rpAll=['/data/object_tracking/batchmark/OTB100_benchmark/tracker_benchmark_v1.0/results/results_OPE_OTB100/'];
end
